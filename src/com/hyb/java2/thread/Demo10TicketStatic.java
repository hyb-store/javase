    ...
    public static /*synchronized*/ void payTicketStatic(){
        synchronized (RunnableImpl4.class){
            ...
            if(ticket>0){
                ...
                //票存在,卖票 ticket--
                System.out.println(Thread.currentThread().getName()+"-->正在111卖第"+ticket+"张票");
                ticket--;
            }
        }
    ...
    public /*synchronized*/ void payTicket(){
        synchronized (this){
            ...
            if(ticket>0){
                ...
                //票存在,卖票 ticket--
                System.out.println(Thread.currentThread().getName()+"-->正在000卖第"+ticket+"张票");
                ticket--;
            }
        }
 ...
 */
public class Demo10TicketStatic {
